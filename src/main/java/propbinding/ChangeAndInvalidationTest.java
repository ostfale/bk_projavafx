...
/**
 * The output below it shows that when the property value changes, both events, invalidation and change,
 * are always fired. This is because a change event makes a property valid immediately after the change,
