...
/**
 * Places a button in an HBox, prints different types of sizes for the button, changes some properties,
 * and prints the sizes of the button again. The output below shows that as the preferred width of the
 * button becomes smaller, its preferred height becomes bigger.
 * Created :  11.05.2020
 *
