...
/**
 * It uses an unmanaged Text node to display a micro help when a node has the focus.
...
public class MicroHelpApp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        // Add a change listener to the scene, so you know when the focus owner changes and display the micro help
