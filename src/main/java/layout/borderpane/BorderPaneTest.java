...
/**
 * Adds children to the right, bottom, and center regions. Two Labels, a TextField, and a TextArea are added
 * to the center region. A VBox with two buttons are added to the right region. A Label to show the status is
 * added to the bottom region. The top and left regions are set to null. The BorderPane is set as the root
 * node for the scene.
 * Created :  18.05.2020
 *
...
public class BorderPaneTest extends Application {
    ...
    public void start(Stage stage) {
        ...
        BorderPane root = new BorderPane(center, null, right, bottom, null);
