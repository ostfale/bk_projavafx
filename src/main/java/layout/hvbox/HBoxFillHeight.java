...
/**
 * The preferred height of the content area of an HBox is the largest of the preferred height of its children.
...
public class HBoxFillHeight extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Add an event handler to the CheckBox, so the user can set the fillHeight property using the CheckBox
