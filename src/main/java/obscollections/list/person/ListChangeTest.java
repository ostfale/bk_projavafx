...
/**
 * It creates an ObservableList with an extractor. The extractor returns an array of firstName and
 * lastName properties of a Person object. That means when one of these properties is changed, a
 * Person object as an element of the list is considered updated and an update notification will
 * be sent to all change listeners. It adds a change listener to the list.
 * Finally, it makes several kinds of changes to the list to trigger change notifications.
 * Created :  04.05.2020
 *
