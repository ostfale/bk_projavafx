...
/**
 * Create an ObservableList that can notify its change listeners when its elements are updated.
 * Created :  04.05.2020
 *
...
public class ListUpdateTest {
    ...
    public static void main(String[] args) {
        ...
        // Create an empty observable list with a callback to extract the observable values for each element of the list
        ...
        list.addAll(p1, p2); // Will call the call() method of the extractor - once for p1 and once for p2
