...
/**
 * Shows how to use mnemonics and accelerator keys. Press Alt + 1 and Alt + 2 to activate Button 1 and Button 2,
 * respectively. Pressing these buttons changes the text for the Label.
