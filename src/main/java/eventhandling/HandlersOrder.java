...
/**
 * Demonstrates the execution order of event handlers for a node. It displays a circle. It registers
...
public class HandlersOrder extends Application {
    ...
    public void handleAnyMouseEvent(MouseEvent e) {
        // Print a message only for mouse-clicked events, ignoring other mouse events such as mouse-pressed, mouse-released, etc.
